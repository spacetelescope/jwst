...
- Ensure matched exposures generated by list of candidates continue processing. [#7485]

=======
cube_build
----------

- Removed allocated and de-allocating spaxel arrays in c code. Now spaxel array
  set to zero are formed in python, passed to the c code, filled in and passed
  back to python code. This results in an improvement of memory needed. Also
  removed forcing cube_build sufffix to be s3d. [#7483]
