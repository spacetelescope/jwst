...
-- the [`latest`](https://jwst-pipeline.readthedocs.io/en/latest/) version is whatever is currently on the main branch, and the [`stable`](https://jwst-pipeline.readthedocs.io/en/stable/)
