...
htmlhelp_basename = 'flatfielddoc'
...
latex_documents = [
  ('index', 'flatfield.tex', 'JWST Science Calibration Pipeline: Flat Field ',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'flatfield', 'JWST Science Calibration Pipeline: Flat Field',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'flatfield', 'JWST Science Calibration Pipeline: Flat Field',
   'STScI', 'flatfield', 'JWST Science Calibration Pipeline: Flat Field',
   'Miscellaneous'),
]
