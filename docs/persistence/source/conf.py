...
latex_documents = [
  ('index', 'persistence.tex', 'JWST Science Calibration Pipeline: Persistence',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'persistence', 'JWST Science Calibration Pipeline: Persistence',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'persistence', 'JWST Science Calibration Pipeline: Persistence',
   'STScI', 'persistence', 'JWST Science Calibration Pipeline: Persistence',
   'Miscellaneous'),
]
