...
latex_documents = [
  ('index', 'resample.tex', 'JWST Science Calibration Pipeline: Image Resampling',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'resample', 'JWST Science Calibration Pipeline: Image Resampling',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'resample', 'JWST Science Calibration Pipeline: Image Resampling',
   'STScI', 'resample', 'JWST Science Calibration Pipeline: Image Resampling',
   'Miscellaneous'),
]
