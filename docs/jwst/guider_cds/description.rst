...
* :ref:`guider_id_mode`
* :ref:`guider_acq_track_modes`
* :ref:`guider_fine_mode`
...
2. :math:`R` is the noise from the :ref:`readnoise_reffile`, or
   the default READNOISE pixel value if the reference file is not accessible.

3. :math:`gain` is the gain from the :ref:`gain_reffile`, or
...
For this mode, the values for the variances are calculated
using the same equations as above for the :ref:`guider_id_mode`, except
...
All modes
---------
For all of the supported modes, the square-root of the sum of the Poisson
