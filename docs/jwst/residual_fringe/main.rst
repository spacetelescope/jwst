...
as a function of the location of a point source within the field-of-view (FOV), the static fringe flat cannot fully correct
...
#. a data model (`~stdatamodels.jwst.datamodels.IFUImageModel`) containing a 2-D IFU image, or
...
the principal fringe sources are the detector layers. A detailed discussion on these fringe components
