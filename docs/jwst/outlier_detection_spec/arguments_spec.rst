.. _outlier_detection_spec_step_args:

Step Arguments
==============

The outlier detection step for spectroscopic data has the following
...
and defaults) see :py:obj:`jwst.outlier_detection.OutlierDetectionSpecStep.spec`.
