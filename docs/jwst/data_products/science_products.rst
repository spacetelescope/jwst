...
NIRCam WFSS, MIR_WFSS, and NIRISS WFSS, there will be multiple tuples of the SCI, ERR, DQ, VAR_POISSON,
...
For NIRCam, MIRIand NIRISS WFSS ``x1d`` products, each row in the table holds the full
