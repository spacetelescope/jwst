Reference Files
===============
The ``straylight`` step uses the :ref:`mrsxartcorr_reffile`,
which stores vectors describing the appropriate cross-artifact convolution kernel
...
Optionally, the ``straylight`` step can also use the :ref:`regions_reffile`
during correction of residual cosmic ray showers.  These reference files
