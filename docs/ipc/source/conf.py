...
latex_documents = [
  ('index', 'ipc.tex', 'JWST Science Calibration Pipeline: IPC Correction',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'ipc', 'JWST Science Calibration Pipeline: IPC Correction',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'ipc', 'JWST Science Calibration Pipeline: IPC Correction',
   'STScI', 'ipc', 'JWST Science Calibration Pipeline: IPC Correction',
   'Miscellaneous'),
]
