...
htmlhelp_basename = 'linearitydoc'
...
latex_documents = [
  ('index', 'linearity.tex', 'JWST Science Calibration Pipeline: Linearity',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'linearity', 'JWST Science Calibration Pipeline: Linearity',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'linearity', 'JWST Science Calibration Pipeline: Linearity',
   'STScI', 'linearity', 'JWST Science Calibration Pipeline: Linearity',
   'Miscellaneous'),
]
