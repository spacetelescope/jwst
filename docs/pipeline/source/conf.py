...
latex_documents = [
  ('index', 'pipeline.tex', 'JWST Science Calibration Pipeline: Pipelines',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'pipeline', 'JWST Science Calibration Pipeline: Pipelines',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'pipeline', 'JWST Science Calibration Pipeline: Pipelines',
   'STScI', 'pipeline', 'JWST Science Calibration Pipeline: Pipelines',
   'Miscellaneous'),
]
