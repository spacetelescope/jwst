...
latex_documents = [
  ('index', 'pipeline.tex', 'JWST Science Calibration Pipeline: User\'s Guide',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'pipeline', 'JWST Science Calibration PipleLine: User\'s Guide',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'pipeline', 'JWST Science Calibration Pipeline: User\'s Guide',
   'STScI', 'pipeline', 'JWST Science Calibration Pipeline: User\'s Guide',
   'Miscellaneous'),
]
