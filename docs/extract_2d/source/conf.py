...
htmlhelp_basename = 'extract2ddoc'
...
latex_documents = [
  ('index', 'extract2d.tex', 'JWST Science Calibration Pipeline: Extract 2D ',
   'STScI', 'manual'),
]
...
man_pages = [
    ('index', 'extract2d', 'JWST Science Calibration Pipeline: Extract 2D',
     ['STScI'], 1)
]
...
texinfo_documents = [
  ('index', 'extract2d', 'JWST Science Calibration Pipeline: Extract 2D',
   'STScI', 'extract2d', 'JWST Science Calibration Pipeline: Extract 2D',
   'Miscellaneous'),
]
