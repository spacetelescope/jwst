...
setup(
    ...
    install_requires=[
        'asdf @ git+https://github.com/spacetelescope/asdf@1b41c6d04f6579#egg=asdf',
        'astropy @ git+https://github.com/astropy/astropy@78d5599888#egg=astropy',
        'crds>=7.2.7',
        'drizzle>=1.13',
        'gwcs @ git+https://github.com/spacetelescope/gwcs@2fc694403#egg=gwcs',
        'jsonschema>=2.3,<4',
        'numpy>=1.16',
        'photutils>=0.7',
        'scipy>=1.0',
