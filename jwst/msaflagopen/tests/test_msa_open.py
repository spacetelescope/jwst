...
def test_id_from_xy():
    ...
    data = {"Q": 1, "x": 1, "y": 1, "state": "closed", "TA state": "closed", "Internal state": "normal", "Vignetted": "yes"}
...
def test_get_failed_open_shutters():
    ...
    for shutter in result:
        assert shutter["state"] == "open" or shutter["Internal state"] == "open" or shutter["TA state"] == "open"
