    ...
    def process(self, input):
        ...
        with datamodels.RampModel(input) as input_model:
            if pipe_utils.is_irs2(input_model):
                ...
                irs2_subtract_reference.flag_bad_refpix(datamodel, n_sigma=self.ovr_corr_mitigation_ftr, flag_only=True)
                ...
                result = irs2_subtract_reference.correct_model(datamodel, irs2_model, preserve_refpix=self.preserve_irs2_refpix)
