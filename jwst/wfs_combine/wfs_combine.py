...
class DataSet:
    ...
    def __init__(self, infile_1, infile_2, outfile, do_refine, flip_dithers, psf_size, blur_size, n_size):
        """
        Short Summary
        -------------
    ...
    def create_aligned_2(self):
        ...
        if self.do_refine:
            ...
            log.info("Approximate centroid of image 1 PSF has x,y : %s %s", round(ctrd_x), round(ctrd_y))
...
def calc_refined_offsets(sci_nai_1, sci_nai_2, off_x, off_y, psf_size):
    ...
    cross_cor = correlate2d(sub_2_sub - gaussian_filter(sub_2_sub, 5), sub_1_sub - gaussian_filter(sub_1_sub, 5))
