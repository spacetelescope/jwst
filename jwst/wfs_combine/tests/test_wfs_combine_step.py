...
def test_step_pos_shift_no_refine_no_flip(wfs_association):
    ...
    wfs = WfsCombineStep.call(path_asn, do_refine=False, flip_dithers=False, psf_size=50, blur_size=10, n_size=2)
...
def test_step_neg_order_no_refine_with_flip(wfs_association):
    ...
    wfs = WfsCombineStep.call(path_asn, do_refine=False, flip_dithers=True, psf_size=50, blur_size=10, n_size=2)
