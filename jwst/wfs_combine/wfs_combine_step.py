...
class WfsCombineStep(Step):
    ...
    def process(self, input_table):
        ...
        for which_set in asn_table["products"]:
            ...
            science_members = [member for member in which_set["members"] if member["exptype"].lower() == "science"]
            ...
            wfs = wfs_combine.DataSet(
                infile_1, infile_2, outfile, self.do_refine, self.flip_dithers, self.psf_size, self.blur_size, self.n_size
            )
