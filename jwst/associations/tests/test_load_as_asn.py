...
@pytest.mark.parametrize(
    "test_input, expected", [("file_rate.fits", "file"), ("file_rate_ref.fits", "file_rate_ref")]
)
...
def test_lv2_asn():
    asn_file = get_pkg_data_filename("data/asn_level2.json", package="jwst.associations.tests")
