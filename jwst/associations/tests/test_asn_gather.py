...
def source_folder(tmp_path_factory):
    ...
    with pushdir(source_folder):
        ...
        primary = asn_from_list(
            primary_members, product_name=PRIMARY_STEM, with_exptype=True
        )
...
@pytest.fixture(
    scope="module", params=[(None, None), (["science"], None), (None, "science")]
)
def gather_simple(source_folder, tmp_path_factory, request):
    ...
    asn_path = asn_gather.asn_gather(
        source_folder / PRIMARY_NAME,
