...
class TestLevel3Spec(BasePoolRule):
    pools = [
        PoolParams(
            path=t_path("data/pool_005_spec_niriss.csv"), n_asns=1, n_orphaned=0
        ),
        PoolParams(
            path=t_path("data/pool_006_spec_nirspec.csv"), n_asns=3, n_orphaned=0
        ),
        PoolParams(path=t_path("data/pool_007_spec_miri.csv"), n_asns=2, n_orphaned=0),
        PoolParams(
            path=t_path("data/pool_019_niriss_wfss.csv"), n_asns=2, n_orphaned=0
        ),
    ]
