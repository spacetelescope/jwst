...
class DataSet:
    ...
    def photom_io(self, tabdata, order=None):
        ...
        if isinstance(self.input, datamodels.MultiSlitModel):
            ...
            spec.spec_table.FLUX_VAR_POISSON[self.integ_row] *= conversion ** 2.
            spec.spec_table.FLUX_VAR_RNOISE[self.integ_row] *= conversion ** 2.
            spec.spec_table.FLUX_VAR_FLAT[self.integ_row] *= conversion ** 2.
            spec.spec_table.BACKGROUND[self.integ_row] *= conversion
            spec.spec_table.BKGD_ERROR[self.integ_row] *= conversion
            spec.spec_table.BKGD_VAR_POISSON[self.integ_row] *= conversion ** 2.
            spec.spec_table.BKGD_VAR_RNOISE[self.integ_row] *= conversion ** 2.
            spec.spec_table.BKGD_VAR_FLAT[self.integ_row] *= conversion ** 2.
