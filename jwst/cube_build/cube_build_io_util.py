...
def read_cubepars(
    ...
    if instrument == "MIRI":
        with datamodels.MiriIFUCubeParsModel(par_filename) as ptab:
            ...
            for i in range(number_bands):
                ...
                if weighting == "msm" and ptab.ifucubepars_msm_table is not None:
                ...
                elif weighting == "emsm" and ptab.ifucubepars_emsm_table is not None:
            ...
            if weighting == "msm" and ptab.ifucubepars_multichannel_msm_wavetable is not None:
            ...
            #  read in wavelength table for modified Shepard method 1/r weighting
            elif weighting == "emsm" and ptab.ifucubepars_multichannel_emsm_wavetable is not None:
                ...
                weighting == "drizzle" and ptab.ifucubepars_multichannel_driz_wavetable is not None
            ):
    ...
    # Read in NIRSPEC Values
        ...
        with datamodels.NirspecIFUCubeParsModel(par_filename) as ptab:
            ...
            if weighting == "msm" and ptab.ifucubepars_prism_msm_wavetable is not None:
                ...
                if ptab.ifucubepars_med_msm_wavetable is not None:
                ...
                if ptab.ifucubepars_high_msm_wavetable is not None:
            ...
            elif weighting == "emsm" and ptab.ifucubepars_prism_emsm_wavetable is not None:
            ...
            elif weighting == "drizzle" and ptab.ifucubepars_prism_driz_wavetable is not None:
