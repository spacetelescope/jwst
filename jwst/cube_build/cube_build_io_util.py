...
def read_cubepars(par_filename, instrument, weighting, all_channel, all_subchannel, all_grating, all_filter, instrument_info):
        ...
        with datamodels.MiriIFUCubeParsModel(par_filename) as ptab:
            ...
            for i in range(number_bands):
                ...
                if weighting == "msm":
                    for tabdata in ptab.ifucubepars_msm_table:
                        ...
                        # match on this_channel and this_sub
                        if this_channel == table_channel and this_sub == table_band:
                            instrument_info.SetMSM(this_channel, this_sub, table_sroi, table_wroi, table_power, table_softrad)
                ...
                #  modified Shepard method e^-r weighting
                    ...
                    for tabdata in ptab.ifucubepars_emsm_table:
                        ...
                        # match on this_channel and this_sub
                        if this_channel == table_channel and this_sub == table_band:
                            instrument_info.SetEMSM(this_channel, this_sub, table_sroi, table_wroi, table_scalerad)
            ...
            if weighting == "msm":
                for tabdata in ptab.ifucubepars_multichannel_msm_wavetable:
                    ...
                    table_power = tabdata["POWER"]
                    table_softrad = tabdata["SOFTRAD"]
                    instrument_info.SetMultiChannelTable(table_wave, table_sroi, table_wroi, table_power, table_softrad)
            #  read in wavelength table for modified Shepard method 1/r weighting
                ...
                for tabdata in ptab.ifucubepars_multichannel_emsm_wavetable:
                    ...
                    table_wroi = tabdata["ROISPECTRAL"]
                    table_scalerad = tabdata["SCALERAD"]
                    instrument_info.SetMultiChannelEMSMTable(table_wave, table_sroi, table_wroi, table_scalerad)
        ...
        with datamodels.NirspecIFUCubeParsModel(par_filename) as ptab:
            ...
            for i in range(number_gratings):
                ...
                if weighting == "msm":
                    for tabdata in ptab.ifucubepars_msm_table:
                        ...
                        if this_gwa == table_grating and this_filter == table_filter:
                            instrument_info.SetMSM(this_gwa, this_filter, table_sroi, table_wroi, table_power, table_softrad)
                #  modified Shepard method e^-r weighting
                elif weighting == "emsm":
                    for tabdata in ptab.ifucubepars_emsm_table:
                        table_grating = tabdata["DISPERSER"].lower()
                        ...
                        if this_gwa == table_grating and this_filter == table_filter:
                            instrument_info.SetEMSM(this_gwa, this_filter, table_sroi, table_wroi, table_scalerad)
            ...
            if weighting == "msm":
                for tabdata in ptab.ifucubepars_prism_msm_wavetable:
                    ...
                    table_power = tabdata["POWER"]
                    table_softrad = tabdata["SOFTRAD"]
                    instrument_info.SetPrismTable(table_wave, table_sroi, table_wroi, table_power, table_softrad)
                ...
                for tabdata in ptab.ifucubepars_med_msm_wavetable:
                    ...
                    table_power = tabdata["POWER"]
                    table_softrad = tabdata["SOFTRAD"]
                    instrument_info.SetMedTable(table_wave, table_sroi, table_wroi, table_power, table_softrad)
                ...
                for tabdata in ptab.ifucubepars_high_msm_wavetable:
                    ...
                    table_power = tabdata["POWER"]
                    table_softrad = tabdata["SOFTRAD"]
                    instrument_info.SetHighTable(table_wave, table_sroi, table_wroi, table_power, table_softrad)
                ...
                for tabdata in ptab.ifucubepars_prism_emsm_wavetable:
                    ...
                    table_wroi = tabdata["ROISPECTRAL"]
                    table_scalerad = tabdata["SCALERAD"]
                    instrument_info.SetPrismEMSMTable(table_wave, table_sroi, table_wroi, table_scalerad)
                ...
                for tabdata in ptab.ifucubepars_med_emsm_wavetable:
                    ...
                    table_wroi = tabdata["ROISPECTRAL"]
                    table_scalerad = tabdata["SCALERAD"]
                    instrument_info.SetMedEMSMTable(table_wave, table_sroi, table_wroi, table_scalerad)
                ...
                for tabdata in ptab.ifucubepars_high_emsm_wavetable:
                    ...
                    table_wroi = tabdata["ROISPECTRAL"]
                    table_scalerad = tabdata["SCALERAD"]
                    instrument_info.SetHighEMSMTable(table_wave, table_sroi, table_wroi, table_scalerad)
