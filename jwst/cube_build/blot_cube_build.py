...
class CubeBlot:
    def __init__(self, median_model, input_models):
        ...
        xcube, ycube, zcube = wcstools.grid_from_bounding_box(self.median_skycube.meta.wcs.bounding_box, step=(1, 1, 1))

        # using wcs of ifu cube determine ra,dec,lambda
        self.cube_ra, self.cube_dec, self.cube_wave = self.median_skycube.meta.wcs(xcube + 1, ycube + 1, zcube + 1)
    ...
    def blot_images_miri(self):
        ...
        for model in self.input_models:
            ...
            x_cube, y_cube = model.meta.wcs.backward_transform(self.cube_ra, self.cube_dec, self.cube_wave)
            ...
            result = blot_wrapper(roi_det, xsize, ysize, xstart, xsize2, xcenter, ycenter, x_cube, y_cube, flux_cube)
    ...
    def blot_images_nirspec(self):
        ...
        for model in self.input_models:
            ...
            for ii in range(nslices):
                ...
                xslice, yslice = detector2slicer.inverse(slx[onslice_ind], sly[onslice_ind], sllam[onslice_ind])
            ...
            result = blot_wrapper(roi_det, blot_xsize, blot_ysize, xstart, xsize2, xcenter, ycenter, x_total, y_total, flux_total)
