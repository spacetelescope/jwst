...
mirifushort_medium = {"detector": "MIRIFUSHORT", "channel": "12", "band": "MEDIUM", "name": "MIRI"}

mirifushort_long = {"detector": "MIRIFUSHORT", "channel": "12", "band": "LONG", "name": "MIRI"}

mirifulong_short = {"detector": "MIRIFULONG", "channel": "34", "band": "SHORT", "name": "MIRI"}

mirifulong_medium = {"detector": "MIRIFULONG", "channel": "34", "band": "MEDIUM", "name": "MIRI"}

mirifulong_long = {"detector": "MIRIFULONG", "channel": "34", "band": "LONG", "name": "MIRI"}

nirspec_G140M = {"detector": "NRS1", "grating": "G140M", "filter": "F100LP", "name": "NIRSPEC"}

nirspec_G235M = {"detector": "NRS1", "grating": "G235M", "filter": "F170LP", "name": "NIRSPEC"}

observation = {"date": "2019-01-01", "time": "17:00:00"}

subarray = {"fastaxis": 1, "name": "FULL", "slowaxis": 2, "xsize": 1032, "xstart": 1, "ysize": 1024, "ystart": 1}

subarray_nirspec = {"fastaxis": 2, "name": "FULL", "slowaxis": 1, "xsize": 2048, "xstart": 1, "ysize": 2048, "ystart": 1}
...
def test_calspec3_config_miri(tmp_cwd, miri_full_coverage):
    ...
    cubeinfo = cube_build.CubeData(miri_full_coverage, par_filename, **pars)
    ...
    num_cubes, cube_pars = cubeinfo.number_cubes()
    assert num_cubes == 12
    assert cubeinfo.all_channel == ["1", "1", "1", "2", "2", "2", "3", "3", "3", "4", "4", "4"]
...
def test_calspec3_config_miri_multi(tmp_cwd, miri_full_coverage):
    ...
    assert cube_pars["1"]["par1"] == ["1", "1", "1", "2", "2", "2", "3", "3", "3", "4", "4", "4"]
...
def test_calspec3_config_nirspec(tmp_cwd, nirspec_medium_coverage):
    ...
    cubeinfo = cube_build.CubeData(nirspec_medium_coverage, par_filename, **pars)
