...
class InstrumentInfo:
    ...
    def Get_med_table(self):
        table = (self.med_wavelength, self.med_sroi, self.med_wroi, self.med_power, self.med_softrad, self.med_scalerad)
        return table

    def Get_high_table(self):
        table = (self.high_wavelength, self.high_sroi, self.high_wroi, self.high_power, self.high_softrad, self.high_scalerad)
        return table
