...
cube_wrapper(PyObject *module, PyObject *args)
{
    ...
    int free_rois_pixel = 0, free_roiw_pixel = 0, free_scalerad_pixel = 0, free_flux = 0, free_err = 0,
        free_zcdelt3 = 0;
    ...
    if (!PyArg_ParseTuple(
            args, "iiiiiiiOOOOOOOOOOOOOOOddd:cube_wrapper", &instrument, &flag_dq_plane, &weight_type, &start_region,
    ...
    if (flag_dq_plane) {
        if (instrument == 0) {
            status1 = dq_miri(
                start_region, end_region, overlap_partial, overlap_full, nxx, nyy, nwave, cdelt1, cdelt2, roiw_ave,
            ...
            status1 = dq_nirspec(
                overlap_partial, nxx, nyy, nwave, cdelt1, cdelt2, roiw_ave, (double *)PyArray_DATA(xc),
