...
static PyObject *cube_wrapper(PyObject *module, PyObject *args) {
  PyObject *result = NULL, *xco, *yco, *zco, *fluxo, *err_o, *coord1o, *coord2o, *waveo, *slicenoo;
  ...
  if (!PyArg_ParseTuple(args, "iiiiiiiOOOOOOOOOOOOOOOddd:cube_wrapper",
			...
			&xco, &yco, &zco, &coord1o, &coord2o, &waveo,  &fluxo, &err_o, &slicenoo,
  ...
  if ((!(xc = ensure_array(xco, &free_xc))) ||
      ...
      (!(err = ensure_array(err_o, &free_err))) ||
