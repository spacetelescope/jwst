...
It has been replaced by a different technique. The code was left  in the jwst pipeline repo for in
case future enhancements are found to make this a useful tool for flagging outliers.
