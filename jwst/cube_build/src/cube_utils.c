...
int
calcCondition(
    int edge, double x1, double y1, double x2, double y2, double left, double right, double top, double bottom)
{
...
find_area_quad(double MinX, double MinY, double Xcorner[], double Ycorner[])
{
    ...
    */
    ...
    Area = 0.5 * ((PX[0] * PY[1] - PX[1] * PY[0]) + (PX[1] * PY[2] - PX[2] * PY[1]) + (PX[2] * PY[3] - PX[3] * PY[2]) +
                  (PX[3] * PY[4] - PX[4] * PY[3]));
