    ...
    double xPixelCorner[], double yPixelCorner[])
{
    ...
    xPixelCorner : ndarray
        X corners of the polygon that is the formed by overlap between detector pixel and cube
    spaxel yPixelCorner : ndarray Y corners of the polygon that is the formed by overlap between
    detector pixel and cube spaxel
