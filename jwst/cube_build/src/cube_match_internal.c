    ...
    double **spaxel_weight, double **spaxel_var, double **spaxel_iflux)
{
    ...
    /* Find the overlap between the detector pixels and spaxels of the IFU cube when the IFU cube is
       of internal cal type.
...
cube_wrapper_internal(PyObject *module, PyObject *args)
{
    ...
    PyObject *result = NULL, *a1o, *a2o, *a3o, *a4o, *lam1o, *lam2o, *lam3o, *lam4o, *fluxo, *erro,
             *acoordo, *zcoordo; // codespell:ignore erro
    ...
    status = match_detector_cube(
        ...
        (double *) PyArray_DATA(lam3), (double *) PyArray_DATA(lam4),
        (double *) PyArray_DATA(acoord), (double *) PyArray_DATA(zcoord), ss,
        (double *) PyArray_DATA(flux), (double *) PyArray_DATA(err), &spaxel_flux, &spaxel_weight,
