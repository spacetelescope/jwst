...
def test_set_input_dir(mk_tmp_dirs):
    ...
    step = Step.from_cmdline(["jwst.stpipe.tests.steps.StepWithModel", input_file, "--input_dir", "junkdir"])
...
def test_use_input_dir(mk_tmp_dirs):
    ...
    step = Step.from_cmdline(["jwst.stpipe.tests.steps.StepWithModel", input_file, "--input_dir", input_dir])
