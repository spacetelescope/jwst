...
def _run_flat_fetch_on_dataset(dataset_path):
    ...
    step = CrdsStep()
    with datamodels.ImageModel(get_pkg_data_filename(dataset_path, package="jwst.stpipe.tests")) as input_file:
        step.run(input_file)
...
def test_crds_step_override(tmp_path):
    ...
    step = CrdsStep(override_flat=get_pkg_data_filename("data/flat.fits", package="jwst.stpipe.tests"))
    with datamodels.ImageModel(get_pkg_data_filename("data/crds.fits", package="jwst.stpipe.tests")) as input_file:
