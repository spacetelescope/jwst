...
def get_steps():
    ...
    return [
        ...
        ("jwst.step.OutlierDetectionCoronStep", 'outlier_detection_coron', False),
        ("jwst.step.OutlierDetectionIFUStep", 'outlier_detection_ifu', False),
        ("jwst.step.OutlierDetectionImagingStep", 'outlier_detection_imaging', False),
        ("jwst.step.OutlierDetectionSpecStep", 'outlier_detection_spec', False),
        ("jwst.step.OutlierDetectionTSOStep", 'outlier_detection_tso', False),
