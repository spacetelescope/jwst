...
def get_steps():
    ...
    return [
        ("jwst.pipeline.Ami3Pipeline", ['calwebb_ami3', 'ami3'], True),
        ("jwst.pipeline.Coron3Pipeline", ['calwebb_coron3', 'coron3'], True),
        ("jwst.pipeline.DarkPipeline", ['calwebb_dark', 'dark'], True),
        ("jwst.pipeline.Detector1Pipeline", ['calwebb_detector1', 'detector1'], True),
        ("jwst.pipeline.GuiderPipeline", ['calwebb_guider', 'guider'], True),
        ("jwst.pipeline.Image2Pipeline", ['calwebb_image2', 'image2'], True),
        ("jwst.pipeline.Image3Pipeline", ['calwebb_image3', 'image3'], True),
        ("jwst.pipeline.Spec2Pipeline", ['calwebb_spec2', 'spec2'], True),
        ("jwst.pipeline.Spec3Pipeline", ['calwebb_spec3', 'spec3'], True),
        ("jwst.pipeline.Tso3Pipeline", ['calwebb_tso3', 'tso3'], True),
        ...
        ("jwst.step.WfsCombineStep", ['calwebb_wfs-image3', 'wfs_combine'], False),
