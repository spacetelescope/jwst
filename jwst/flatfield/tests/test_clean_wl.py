...
def test_clean_wl_1():
    ...
    wl_h_clean = np.array(
        [
            ...
            [2.01, 2.01, 2.01, 3.0, 4.0, 5.0, 6.0, 7.01, 7.01],
    ...
    assert np.allclose(wl_hc, wl_h_clean, atol=0.0, rtol=1.0e-6)
...
def test_clean_wl_2():
    ...
    wl_v_clean = np.array(
        [
            ...
            [7.01, 7.01, 7.01, 7.01, 7.01],
            [6.005, 6.0, 6.01, 6.005, 6.005],
            [5.005, 5.0, 5.01, 5.005, 5.005],
            [4.01, 4.0, 4.01, 4.02, 4.01],
            [3.005, 3.0, 3.01, 3.005, 3.005],
    ...
    assert np.allclose(wl_vc, wl_v_clean, atol=0.0, rtol=1.0e-6)
