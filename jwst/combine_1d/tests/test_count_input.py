...
def truth_array_1a():
    """Test merged and sorted wavelengths from all input files."""
...
def truth_array_1b():
    """
    Test number of input models that cover wavelengths in the combined array.
...
def truth_array_1c():
    """
    Test computed wavelengths for the output.
    ...
    between pixels.
    """
    return np.array([1.3875, 1.71525, 1.99175, 2.24325, 2.48425, 2.72725], dtype=np.float64)
