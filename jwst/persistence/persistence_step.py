...
class PersistenceStep(Step):
    ...
    def process(self, input):
        ...
        self.trap_density_filename = self.get_reference_file(output_obj, "trapdensity")
        self.trappars_filename = self.get_reference_file(output_obj, "trappars")
        ...
        if traps_filled is not None:  # output traps_filled
            ...
            self.save_model(traps_filled, suffix="trapsfilled", force=self.save_trapsfilled)
            traps_filled.close()
