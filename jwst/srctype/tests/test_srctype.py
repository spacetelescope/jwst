...
def test_nrs_msaspec():
    ...
    slits = [{"source_id": 1, "stellarity": 0.9}, {"source_id": 2, "stellarity": -1}, {"source_id": 3, "stellarity": 0.5}]
...
@pytest.mark.parametrize("exptype", ["NRS_BRIGHTOBJ", "NRC_TSGRISM", "NIS_SOSS", "MIR_LRS-SLITLESS"])
