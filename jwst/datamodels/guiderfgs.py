...
__all__ = ['GuiderFGSModel']

class GuiderFGSModel( model_base.DataModel ):
    """
    A base class for FGS guider images.
    """
    schema_url = "guiderfgs.schema.yaml"

    def __init__(self, init=None, data=None, dq=None, **kwargs): 
        super(GuiderFGSModel, self).__init__(init=init, **kwargs)


class GuiderRawModel( GuiderFGSModel ):
    """
    ...
    schema_url = "guider_fgs_raw.schema.yaml"
...
class GuiderCalModel( GuiderFGSModel ):
    """
    ...
    track_sub_table: table
        The track subarray table
    """
    schema_url = "guider_fgs_cal.schema.yaml"
