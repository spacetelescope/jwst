...
class TSOPhotometryStep(Step):
    ...
    def process(self, input_data):
        ...
        with CubeModel(input_data) as model:
            ...
            catalog = tso_aperture_photometry(model, xcenter, ycenter, radius, radius_inner, radius_outer)
            ...
            if self.save_catalog:
                ...
                cat_filepath = replace_suffix_ext(
                    model.meta.filename, old_suffixes, "phot", output_ext="ecsv", output_dir=output_dir
                )
