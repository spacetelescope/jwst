...
def test_dark_current_nircam():
    ...
    DarkCurrentStep.call(BIGDATA+'/nircam/test_dark_step/jw00017001001_01101_00001_NRCA1_saturation.fits',
                         output_file=output_file_base
                         )
    h = pf.open(output_file)
    href = pf.open(BIGDATA+'/nircam/test_dark_step/jw00017001001_01101_00001_NRCA1_dark_current.fits')
