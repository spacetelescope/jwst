...
def test_nirspec_nrs1_wcs():
    ...
    input_file = os.path.join(BIGDATA, 'nirspec', 'test_wcs', 'nrs1-ifu', 'jw00011001001_01120_00001_NRS1_rate.fits')
    ref_file = os.path.join(BIGDATA, 'nirspec', 'test_wcs', 'nrs1-ifu', 'jw00011001001_01120_00001_NRS1_rate_assign_wcs.fits')
