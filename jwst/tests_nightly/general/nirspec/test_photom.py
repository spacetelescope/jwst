...
def test_photom_nirspec(_bigdata):
    ...
    href = fits.open(_bigdata+'/nirspec/test_photom/jw00023001001_01101_00001_NRS1_photom.fits')
    newh = fits.HDUList([h['primary'],h['sci',1],h['err',1],h['dq',1],h['relsens',1],
                                    h['sci',2],h['err',2],h['dq',2],h['relsens',2],
                                    h['sci',3],h['err',3],h['dq',3],h['relsens',3],
                                    h['sci',4],h['err',4],h['dq',4],h['relsens',4]])
    newhref = fits.HDUList([href['primary'],href['sci',1],href['err',1],href['dq',1],href['relsens',1],
