...
def test_one_group_not_suppressed_one_integration(setup_inputs):
    ...
    check = np.array([[[0.0, 2.0099752, 0.4582576]]])
...
def test_one_group_suppressed_one_integration(setup_inputs):
    ...
    # Check slopes information
    check = np.array([[0.0, 0.0, 1.0000002]])
    np.testing.assert_allclose(slopes.data, check, tol)

    check = np.array([[3, 3, 0]])
    np.testing.assert_allclose(slopes.dq, check, tol)

    check = np.array([[0.0, 0.0, 0.01]])
    np.testing.assert_allclose(slopes.var_poisson, check, tol)

    check = np.array([[0.0, 0.0, 0.19999999]])
    np.testing.assert_allclose(slopes.var_rnoise, check, tol)

    check = np.array([[0.0, 0.0, 0.45825756]])
    np.testing.assert_allclose(slopes.err, check, tol)

    # Check slopes information
    check = np.array([[[0.0, 0.0, 1.0000001]]])
    np.testing.assert_allclose(cube.data, check, tol)
    ...
    check = np.array([[[0.0, 0.0, 0.4582576]]])
    np.testing.assert_allclose(cube.err, check, tol)
...
def test_one_group_not_suppressed_two_integration(setup_inputs):
    ...
    # Check slopes information
    check = np.array([[[0.0, 1.0, 1.0000001]], [[1.0000001, 1.0000001, 1.0000001]]])
    np.testing.assert_allclose(cube.data, check, tol)

    check = np.array([[[3, 2, 0]], [[0, 0, 0]]])
    np.testing.assert_allclose(cube.dq, check, tol)

    check = np.array([[[0.0, 0.04, 0.01]], [[0.005, 0.01, 0.01]]])
    np.testing.assert_allclose(cube.var_poisson, check, tol)

    check = np.array(
        [[[0.0, 3.9999995, 0.19999999]], [[0.19999999, 0.19999999, 0.19999999]]]
    )
    np.testing.assert_allclose(cube.var_rnoise, check, tol)

    check = np.array(
        [[[0.0, 2.0099752, 0.4582576]], [[0.45276922, 0.4582576, 0.4582576]]]
    )
    np.testing.assert_allclose(cube.err, check, tol)
...
def test_one_group_suppressed_two_integration(setup_inputs):
    ...
    # Check slopes information
    check = np.array([[[0.0, 0.0, 1.0000001]], [[1.0000001, 1.0000001, 1.0000001]]])
    np.testing.assert_allclose(cube.data, check, tol)

    check = np.array([[[3, 3, 0]], [[0, 0, 0]]])
    np.testing.assert_allclose(cube.dq, check, tol)

    check = np.array([[[0.0, 0.0, 0.01]], [[0.005, 0.01, 0.01]]])
    np.testing.assert_allclose(cube.var_poisson, check, tol)

    check = np.array([[[0.0, 0.0, 0.19999999]], [[0.19999999, 0.19999999, 0.19999999]]])
    np.testing.assert_allclose(cube.var_rnoise, check, tol)

    check = np.array([[[0.0, 0.0, 0.4582576]], [[0.45276922, 0.4582576, 0.4582576]]])
    np.testing.assert_allclose(cube.err, check, tol)
