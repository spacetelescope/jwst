...
def test_pix_4():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [15.0, 25.0, 35.0, 54.0, 1055.0, 1065.0, 1075.0, 2594.0, 2595.0, 2605.0],
        dtype=np.float32,
    )
    ...
    # Set truth values for OPTIONAL results:
    o_true = [1.5, 0.0, 0.02727273, 1.0691562, 0.0, 0.0, 0.0, 0.8318386]
...
def test_pix_5():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [15.0, 25.0, 35.0, 54.0, 2055.0, 2065.0, 2075.0, 2094.0, 2095.0, 2105.0],
        dtype=np.float32,
    )
...
def test_pix_6():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [15.0, 25.0, 35.0, 54.0, 55.0, 65.0, 375.0, 394.0, 395.0, 405.0],
        dtype=np.float32,
    )
...
def test_pix_10():
    ...
    # Set truth values for PRIMARY results:
    p_true = [1.0, 4, 0.21298744, 0.0025974, 0.04276625]
...
def test_pix_11():
    ...
    # Set truth values for PRIMARY results:
    p_true = [1.0, 2, 1.042755, 0.01818182, 1.0691562]

    # Set truth values for OPTIONAL results:
    o_true = [1.0, 56.870003, 0.01818182, 1.0691562, 15.0, 56.870003, 5.0, 0.84580624]
...
def test_pix_12():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array([15.0, 59025.0], dtype=np.float32)
    ramp_model.groupdq[0, :, 0, 0] = np.array([0, 2])
    ramp_model.data[0, :, 0, 1] = np.array([61000.0, 61000.0], dtype=np.float32)
    ...
    o_true = [1.5, 0.0, 0.027273, 1.069156, 0.0, 0.0, 0.0, 0.831839]
...
def test_miri_0():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [8888.0, 25.0, 35.0, 54.0, 55.0, 65.0, 75.0, 94.0, 95.0, 888.0],
        dtype=np.float32,
    )
...
def test_miri_1():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [7777.0, 125.0, 135.0, 154.0, 165.0, 175.0, 185.0, 204.0, 205.0, 777.0],
        dtype=np.float32,
    )
...
def test_miri_2():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [4444.0, 25.0, 35.0, 54.0, 55.0, 65.0, 75.0, 94.0, 95.0, 444.0],
        dtype=np.float32,
    )
...
def test_miri_3():
    ...
    # Populate pixel-specific SCI and GROUPDQ arrays
    ramp_model.data[0, :, 0, 0] = np.array(
        [6666.0, 25.0, 35.0, 54.0, 55.0, 65.0, 75.0, 94.0, 95.0, 666.0],
        dtype=np.float32,
    )
