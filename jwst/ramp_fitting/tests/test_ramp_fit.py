...
UNDERSAMP = 128  # replace once PR for 3015 is mergaed
...
def test_readnoise_variance():
    ...
    model1, gdq_4d, rnoise, pixdq, err, gain = setup_inputs(ngroups=10, nints=3,
        nrows=3, ncols=4, nframes=1, gain=1, readnoise=0.7071, grouptime=group_time)
