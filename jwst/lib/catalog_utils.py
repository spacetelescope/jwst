...
class SkyObject(
    ...
    def __str__(self):
        ...
        return (
            ...
            f"sky_centroid: {self.sky_centroid!s}\n"
            f"isophotal_abmag: {self.isophotal_abmag}\n"
            f"isophotal_abmag_err: {self.isophotal_abmag_err}\n"
            f"sky_bbox_ll: {self.sky_bbox_ll!s}\n"
            f"sky_bbox_lr: {self.sky_bbox_lr!s}\n"
            f"sky_bbox_ul: {self.sky_bbox_ul!s}\n"
            f"sky_bbox_ur: {self.sky_bbox_ur!s}\n"
            f"is_extended: {self.is_extended!s}"
        )
