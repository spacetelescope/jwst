...
def test_add_wcs_default(data_file):
    ...
    assert word_precision_check(
        ...
        (
            'POLYGON ICRS'
            ' 87.35195509546267 23.769863606303208'
            ' 162.3242788138022 -5.822024275663281'
            ' 252.57185658565385 -44.61468545033361'
            ' 354.3013888280989 -9.708023123374687'
        )
    )
...
def test_add_wcs_with_db(eng_db, data_file, siaf_file=siaf_db):
    ...
    assert word_precision_check(
        ...
        (
            'POLYGON ICRS'
            ' 49.94631855578844 13.54626907503696'
            ' 141.8153037247197 -21.67420560918717'
            ' 232.26127875138587 -33.0175891665321'
            ' 319.06151974465143 -2.2525893046291436'
        )
    )
