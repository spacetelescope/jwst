    ...
    [
        ...
        (
            ...
            [
                ...
                EngDB_Value(
                    obstime=Time("2022-02-02T22:24:58.309", scale="utc", format="isot"),
                    value=-0.7914494276,
                ),
                EngDB_Value(
                    obstime=Time("2022-02-02T22:24:58.565", scale="utc", format="isot"),
                    value=-0.7914494276,
                ),
                EngDB_Value(
                    obstime=Time("2022-02-02T22:24:58.821", scale="utc", format="isot"),
                    value=-0.791449368,
                ),
            ],
        ),
        (
            ...
            EngDB_Value(
                obstime=[
                    Time("2022-02-02T22:24:58.053", scale="utc", format="isot"),
