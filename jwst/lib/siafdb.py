...
SIAF = namedtuple("SIAF", ["v2_ref", "v3_ref", "v3yangle", "vparity", "crpix1", "crpix2", "cdelt1", "cdelt2", "vertices_idl"])
...
SIAF.__new__.__defaults__ = (None, None, None, None, 0, 0, 3600, 3600, (0, 1, 1, 0, 0, 0, 1, 1))

SIAF_REQUIRED = ["V2Ref", "V3Ref", "V3IdlYAngle", "VIdlParity"]
SIAF_OPTIONAL = ["XSciRef", "YSciRef", "XSciScale", "YSciScale"]
SIAF_VERTICIES = ["XIdlVert1", "XIdlVert2", "XIdlVert3", "XIdlVert4", "YIdlVert1", "YIdlVert2", "YIdlVert3", "YIdlVert4"]
SIAF_MAP = {
    "V2Ref": "v2_ref",
    "V3Ref": "v3_ref",
