...
def test_ignore_regions(tmp_cwd, monkeypatch, miri_image, log_watcher):
    ...
    watcher = log_watcher("stpipe.jwst.residual_fringe", message="Ignoring 2 wavelength regions")
...
def test_rf_step_wrong_exptype(miri_image, log_watcher):
    ...
    watcher = log_watcher("stpipe.jwst.residual_fringe", message="only for MIRI MRS")
