...
def test_wavecorr():
    ...
    wave_transform1 = wavecorr.calculate_wavelength_correction_transform(lam_uncorr, dispersion, freference, source_xpos1, "MOS")
    wave_transform2 = wavecorr.calculate_wavelength_correction_transform(lam_uncorr, dispersion, freference, source_xpos2, "MOS")
...
def test_skipped():
    ...
    transform = wavecorr.calculate_wavelength_correction_transform(lam, disp, reffile, source_xpos, aperture_name)
