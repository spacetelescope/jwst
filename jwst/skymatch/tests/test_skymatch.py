...
def test_asn_input(nircam_rate, tmp_path):
    ...
    im1_path = str(tmp_path / "skymatch_im1.fits")
    im2_path = str(tmp_path / "skymatch_im2.fits")
    im3_path = str(tmp_path / "skymatch_im3.fits")
    ...
    asn_out_fname = str(tmp_path / asn_out_fname)
...
def test_skymatch_2x(nircam_rate, tmp_path, skymethod, subtract):
