...
def test_correct_mrs_xartifact():
    ...
    # Test C version
    result_c = makemodel_ccode(image, xvec, istart, istop, lorfwhm, lorscale, gaufwhm, gauxoff, gauscale1, gauscale2)
    cutout_c = result_c[500, 270:330]

    # Test python version
    result_py = makemodel_composite(image, xvec, istart, istop, lorfwhm, lorscale, gaufwhm, gauxoff, gauscale1, gauscale2)
