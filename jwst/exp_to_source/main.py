...
class Main:
    ...
    def __init__(self, args=None):
        ...
        parser = argparse.ArgumentParser(
            description="Convert exposure-based data to source-based data", usage="python -m jwst.exp_to_source.main files"
        )
        parser.add_argument("files", type=str, nargs="+", help="Files to convert")

        parser.add_argument(
            "-o", "--output-path", type=str, default=".", help='Folder to save results in. Default: "%(default)s"'
        )
