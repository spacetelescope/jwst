...
def test_nirspec_ifu_against_esa(wcs_ifu_grating):
    ...
    """
    ref = fits.open(
        get_file_path("Trace_IFU_Slice_00_SMOS-MOD-G1M-17-5344175105_30192_JLAB88.fits")
    )
...
def test_nirspec_fs_esa():
    ...
    ref = fits.open(
        get_file_path("Trace_SLIT_A_200_1_V84600010001P0000000002101_39547_JLAB88.fits")
    )
...
def test_correct_tilt():
    ...
    disp.meta = {
        "instrument": {"name": "NIRSPEC", "detector": "NRS1"},
        "reftype": "DISPERSER",
    }
...
def test_msa_configuration_normal():
    ...
    slitlet_info = nirspec.get_open_msa_slits(
        msaconfl, msa_meta_id, dither_position, slit_y_range=[-0.5, 0.5]
    )
...
def test_functional_ifu_grating(wcs_ifu_grating):
    ...
    im, refs = wcs_ifu_grating(
        "G395H", "F290LP", gwa_xtil=0.35986012, gwa_ytil=0.13448857
    )
...
def test_ifu_bbox():
    bbox = {
        0: (
            (122.0908542999878, 1586.2584665188083),
            (773.5411133037417, 825.1150258966278),
        ),
        1: (
            (140.3793485788431, 1606.8904629423566),
            (1190.353197027459, 1243.0853605832503),
        ),
        2: (
            (120.0139534379125, 1583.9271768905855),
            (724.3249534782219, 775.8104288584977),
        ),
        3: (
            (142.50252648927454, 1609.3106221382388),
            (1239.4122720740888, 1292.288713688988),
        ),
        4: (
            (117.88884113088403, 1581.5517394150106),
            (674.9787657901347, 726.3752061973377),
        ),
        5: (
            (144.57465414462143, 1611.688447569682),
            (1288.4808318659427, 1341.5035313084197),
        ),
        6: (
            (115.8602297714846, 1579.27471654949),
            (625.7982466386104, 677.1147840452901),
        ),
        7: (
            (146.7944728147906, 1614.2161842198498),
            (1337.531525654835, 1390.7050687363856),
        ),
        8: (
            (113.86384530944383, 1577.0293086386203),
            (576.5344359685643, 627.777022204828),
        ),
        9: (
            (149.0259581360621, 1616.7687282225652),
            (1386.5118806905086, 1439.843598490326),
        ),
        10: (
            (111.91564190274217, 1574.8351095461135),
            (527.229828693075, 578.402894851317),
        ),
        11: (
            (151.3053466801954, 1619.3720722471498),
            (1435.423685040875, 1488.917203728964),
        ),
        12: (
            (109.8957204607345, 1572.570246400894),
            (477.9699083444277, 529.0782087498488),
        ),
        13: (
            (153.5023503173659, 1621.9005029476564),
            (1484.38405923062, 1538.0443479389924),
        ),
        14: (
            (107.98320121613297, 1570.411787034636),
            (428.6704834494425, 479.7217241891257),
        ),
        15: (
            (155.77991404913857, 1624.5184927460925),
            (1533.169633314481, 1586.9984359105376),
        ),
        16: (
            (106.10212081215678, 1568.286103827344),
            (379.3860245240618, 430.3780648366697),
        ),
        17: (
            (158.23149941845386, 1627.305849064835),
            (1582.0496119714928, 1636.0513450787032),
        ),
        18: (
            (104.09366374413436, 1566.030231370944),
            (330.0822744105267, 381.01974582564395),
        ),
        19: (
            (160.4511021152353, 1629.888830991371),
            (1630.7797743277185, 1684.9592727079018),
        ),
        20: (
            (102.25220592881234, 1563.9475099032868),
            (280.7233309522168, 331.6093009077988),
        ),
        21: (
            (162.72784286205734, 1632.5257403739463),
            (1679.6815760587567, 1734.03692957156),
        ),
        22: (
            (100.40115742738622, 1561.8476640376036),
            (231.35443588323855, 282.19575854747006),
        ),
        23: (
            (165.05939163941662, 1635.2270773628682),
            (1728.511467615387, 1783.0485841263735),
        ),
        24: (
            (98.45723949658425, 1559.6499479349648),
            (182.0417295679079, 232.83530870639865),
        ),
        25: (
            (167.44628840053574, 1637.9923229870349),
            (1777.2512197664128, 1831.971115503598),
        ),
        26: (
            (96.56508092457855, 1557.5079027818058),
            (132.5285162704088, 183.27350269292484),
        ),
        27: (
            (169.8529496136358, 1640.778485168005),
            (1826.028691168028, 1880.9336718824313),
        ),
        28: (
            (94.71390837793813, 1555.4048050512263),
            (82.94691422559131, 133.63901517357235),
        ),
        29: (
            (172.3681094850081, 1643.685604697228),
    ...
    for sl in range(30):
        ...
        m = functools.reduce(
            lambda x, y: x | y, [tr.inverse for tr in transforms[:3][::-1]]
        )
...
def test_in_slice(slice, wcs_ifu_grating, ifu_world_coord):
    ...
    xinv, yinv = detector2slicer.inverse(
