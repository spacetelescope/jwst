...
def create_model_2d():
    ...
    im.meta.wcsinfo.pc1_1 = 1.0
    im.meta.wcsinfo.pc1_2 = 0
    im.meta.wcsinfo.pc2_1 = 0.0
    im.meta.wcsinfo.pc2_2 = 1.0
    return im
...
def test_sip_approx(tmp_path):
    ...
    pipe = AssignWcsStep()
    result = pipe.call(im, sip_max_pix_error=0.1, sip_degree=3, sip_max_inv_pix_error=0.1, sip_inv_degree=3, sip_npoints=12)
