...
def add_configuration_records(filename):
    ...
    test2 = np.array([
                ...
                (56, 13, 4, 251, 24, 1, 'N', 'OPEN', np.nan, np.nan),
                (56, 13, 4, 251, 25, 1, 'N', 'OPEN', np.nan, np.nan),
                (56, 13, 4, 251, 26, 1, 'N', 'OPEN', 0.18283921, 0.31907734),
               ],\
              rectype)

    # Test 3: No non-background
    test3 = np.array([
    ...
    test5 = np.array([
                (58, 16, 4, 251, 22, 1, 'Y', 'OPEN', np.nan, np.nan),
                (58, 16, 4, 251, 23, 1, 'Y', 'OPEN', 0.18283921, 0.31907734),
                (58, 16, 4, 251, 24, 1, 'N', 'OPEN', 0.18283921, 0.31907734),
                (58, 16, 4, 251, 25, 1, 'Y', 'OPEN', 0.18283921, 0.31907734),
                (58, 16, 4, 251, 27, 1, 'Y', 'OPEN', 0.18283921, 0.31907734),
                (58, 16, 4, 251, 28, 1, 'Y', 'OPEN', 0.18283921, 0.31907734),
