...
def main():
    ...
    parser.add_argument("-ib", "--ignore_blanks",
    ...
    parser.add_argument("ibc", "--ignore_blank_cards",
    ...
    parser.add_argument("-rpl", "--report_pixel_loc_diffs",
    ...
    parser.add_argument("-et", "--extension_tolerances",
                        dest="extension_tolerances", action="store", default=None,
