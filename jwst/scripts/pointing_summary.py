...
# Begin execution
def main():
    parser = argparse.ArgumentParser(description="Summarize various pointing information in a table.")

    parser.add_argument("exposures", type=str, nargs="+", help="List of JWST data files to examine.")
    parser.add_argument(
        "-o",
        "--output",
    ...
    parser.add_argument(
        "--extra-meta", type=str, nargs="+", help="Extra meta information from the exposures to add to the result table"
    )
