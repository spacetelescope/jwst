...
def make_ifu_cube(
    ...
    def mock_wcs(x, y, z):
        ...
        wavelength = np.linspace(
            0.5975, 5.2975, 941, endpoint=True, retstep=False, dtype=np.float64
        )
...
def make_ref_image(
    shape, x_center=None, y_center=None, radius=None, inner_bkg=None, outer_bkg=None
):
