...
def make_background_mask(deepstack, width=28):
    ...
    if nrows == 96:  # SUBSTRIP96
        ...
        msg = f"Unexpected image dimensions, expected nrows = 96, 256 or 2048, " f"got nrows = {nrows}."
        log.critical(msg)
        raise ValueError(msg)
...
def soss_oneoverf_correction(scidata, scimask, deepstack, bkg_mask=None, zero_bias=False):
