...
def ifu_extract1d(
    ...
    spec.spec_table_units.FLUX = "Jy"
    spec.spec_table_units.FLUX_ERROR = "Jy"
    spec.spec_table_units.FLUX_VAR_POISSON = "Jy^2"
    spec.spec_table_units.FLUX_VAR_RNOISE = "Jy^2"
    spec.spec_table_units.FLUX_VAR_FLAT = "Jy^2"
    spec.spec_table_units.SURF_BRIGHT = "MJy/sr"
    spec.spec_table_units.SB_ERROR = "MJy/sr"
    spec.spec_table_units.SB_VAR_POISSON = "(MJy/sr)^2"
    spec.spec_table_units.SB_VAR_RNOISE = "(MJy/sr)^2"
    spec.spec_table_units.SB_VAR_FLAT = "(MJy/sr)^2"
    spec.spec_table_units.BACKGROUND = "MJy/sr"
    spec.spec_table_units.BKGD_ERROR = "MJy/sr"
    spec.spec_table_units.BKGD_VAR_POISSON = "(MJy/sr)^2"
    spec.spec_table_units.BKGD_VAR_RNOISE = "(MJy/sr)^2"
    spec.spec_table_units.BKGD_VAR_FLAT = "(MJy/sr)^2"
    if input_model.meta.instrument.name == "MIRI":
        spec.spec_table_units.RF_FLUX = "Jy"
        spec.spec_table_units.RF_SURF_BRIGHT = "MJy/sr"
        spec.spec_table_units.RF_BACKGROUND = "MJy/sr"
