...
def ifu_extract1d(
    ...
    spec.spec_table["FLUX"].unit = "Jy"
    spec.spec_table["FLUX_ERROR"].unit = "Jy"
    spec.spec_table["FLUX_VAR_POISSON"].unit = "Jy^2"
    spec.spec_table["FLUX_VAR_RNOISE"].unit = "Jy^2"
    spec.spec_table["FLUX_VAR_FLAT"].unit = "Jy^2"
    spec.spec_table["SURF_BRIGHT"].unit = "MJy/sr"
    spec.spec_table["SB_ERROR"].unit = "MJy/sr"
    spec.spec_table["SB_VAR_POISSON"].unit = "(MJy/sr)^2"
    spec.spec_table["SB_VAR_RNOISE"].unit = "(MJy/sr)^2"
    spec.spec_table["SB_VAR_FLAT"].unit = "(MJy/sr)^2"
    spec.spec_table["BACKGROUND"].unit = "MJy/sr"
    spec.spec_table["BKGD_ERROR"].unit = "MJy/sr"
    spec.spec_table["BKGD_VAR_POISSON"].unit = "(MJy/sr)^2"
    spec.spec_table["BKGD_VAR_RNOISE"].unit = "(MJy/sr)^2"
    spec.spec_table["BKGD_VAR_FLAT"].unit = "(MJy/sr)^2"
    if input_model.meta.instrument.name == "MIRI":
        spec.spec_table["RF_FLUX"].unit = "Jy"
        spec.spec_table["RF_SURF_BRIGHT"].unit = "MJy/sr"
        spec.spec_table["RF_BACKGROUND"].unit = "MJy/sr"
