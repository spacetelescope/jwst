...
def run_spec2_mbkg(rtdata_module):
    ...
    step_params = {
        "step": "calwebb_spec2",
        "args": ["--steps.master_background_mos.skip=false", "--steps.master_background_mos.save_background=true"],
    }
...
@pytest.mark.parametrize("suffix", ["masterbg1d", "masterbg2d", "cal", "s2d", "x1d"])
...
def test_nirspec_fs_mbkg_user(rtdata, fitsdiff_default_kwargs):
    ...
    MasterBackgroundStep.call(rtdata.input, save_results=True, suffix="master_background", user_background=user_background)
...
def test_nirspec_ifu_mbkg_user(rtdata, fitsdiff_default_kwargs):
    ...
    MasterBackgroundStep.call(rtdata.input, user_background=user_background, save_results=True, suffix="master_background")
...
def test_nirspec_ifu_mbkg_nod(rtdata, fitsdiff_default_kwargs, output_file):
    ...
    MasterBackgroundStep.call(rtdata.input, save_background=True, save_results=True, suffix="master_background")
