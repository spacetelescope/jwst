...
def test_jw02739_20230710t150016_pool(_jail, rtdata, resource_tracker, request):
    """Test the Asn_Lv3ImageMosaic rule."""
    pool_args = ("jw02739_20230710t150016_pool", ["-i", "c1000"])
