...
def run_pipeline(rtdata_module):
    ...
    MasterBackgroundStep.call(rtdata.input, user_background=user_bkg, save_results=True, suffix="master_background")
...
def test_miri_lrs_masterbg_user(run_pipeline, fitsdiff_default_kwargs):
    ...
    # Get the truth file
    rtdata.get_truth(os.path.join("truth/test_miri_lrs_masterbg_user", "miri_lrs_sci+bkg_master_background.fits"))
