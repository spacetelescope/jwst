...
def test_tso3_x1dints(run_tso3_pipeline, fitsdiff_default_kwargs):
    ...
    rtdata.get_truth("truth/test_nirspec_brightobj_tso3/jw01118005001_04101_00001-first20_x1dints.fits")
...
def test_tso3_whtlt(run_tso3_pipeline, diff_astropy_tables):
    ...
    rtdata.get_truth("truth/test_nirspec_brightobj_tso3/jw01118005001_04101_00001-first20_whtlt.ecsv")
