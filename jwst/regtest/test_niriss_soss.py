...
@pytest.fixture()
def run_tso_spec3(jail, rtdata, run_tso_spec2):
...
def run_atoca_extras(jail, rtdata):
    ...
    rtdata.get_data("niriss/soss/jw01091002001_03101_00001-seg002_nis_short_rateints.fits")
    args = ["calwebb_spec2", rtdata.input,
            "--steps.extract_1d.soss_modelname=jw01091002001_03101_00001-seg002_nis_short",
...
@pytest.mark.bigdata
def test_niriss_soss_stage3_crfints(rtdata, run_tso_spec3, fitsdiff_default_kwargs):
...
@pytest.mark.bigdata
def test_niriss_soss_stage3_x1dints(run_tso_spec3, rtdata, fitsdiff_default_kwargs):
...
@pytest.mark.bigdata
def test_niriss_soss_stage3_whtlt(run_tso_spec3, rtdata, diff_astropy_tables):
