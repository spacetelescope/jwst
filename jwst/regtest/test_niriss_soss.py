...
def run_tso_spec2(tmp_cwd_module, rtdata_module):
...
@pytest.fixture(scope="module")
def run_atoca_extras(tmp_cwd_module, rtdata_module):
...
@pytest.fixture(scope='module')
def run_extract1d_spsolve_failure(tmp_cwd_module, rtdata_module):
    """
...
@pytest.fixture(scope='module')
def run_extract1d_null_order2(tmp_cwd_module, rtdata_module):
    """
