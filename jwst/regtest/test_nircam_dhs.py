...
def test_nircam_dhs_sw_det1(run_sw_det1pipeline, rtdata_module, fitsdiff_default_kwargs, suffix):
...
def test_nircam_dhs_lw_det1(run_lw_det1pipeline, rtdata_module, fitsdiff_default_kwargs, suffix):
    """Regression test of detector1 pipeline performed on NIRCam DHS mock data."""
    rtdata = rtdata_module
    rtdata.input = "jw04453010001_02106_00001_nrcalong_genheader_uncal.fits"
    output = "jw04453010001_02106_00001_nrcalong_genheader_" + suffix + ".fits"
    rtdata.output = output
    rtdata.get_truth(f"truth/test_nircam_dhs/{output}")
...
def test_nircam_dhs_sw_spec2(run_sw_spec2pipeline, rtdata_module, fitsdiff_default_kwargs, suffix):
    """Regression test of detector1 pipeline performed on NIRCam DHS mock data."""
    rtdata = rtdata_module
    rtdata.input = "jw04453010001_02106_00001_nrca1_genheader_rateints.fits"
    output = "jw04453010001_02106_00001_nrca1_genheader_" + suffix + ".fits"
...
def test_nircam_dhs_lw_spec2(run_lw_spec2pipeline, rtdata_module, fitsdiff_default_kwargs, suffix):
    """Regression test of detector1 pipeline performed on NIRCam DHS mock data."""
    rtdata = rtdata_module
    rtdata.input = "jw04453010001_02106_00001_nrcalong_genheader_rateints.fits"
    output = "jw04453010001_02106_00001_nrcalong_genheader_" + suffix + ".fits"
