...
@pytest.mark.parametrize("pool_args", [
    ...
    ("jw04492_20250316t024506_pool", []),  # pool_007_spec_miri (FIXED SLIT)
...
@pytest.mark.parametrize("pool_args", [
    ...
    ("jw02739_20230710t150016_pool", ["-i", "c1000"]),  # This association tests the Asn_Lv3ImageMosaic rule
    ("jw03596_20240314t012345_pool", []),
    ("jw03855_20241103t042455_pool", []),
    ("jw04225_20241213t150701_pool", ["-i", "o001", "o002"]),  # This pair of pools test the DMS flag usage to prevent o-type ASNs when a background c-type candidate is attached to the science exposure.
    ("jw04225_20241213t150701DMS_pool", ["--DMS", "-i", "o001", "o002"]),
    ("jw05554_20250528t204800_c1012_pool", ["--DMS", "-i", "o009", "o010", "c1012"]),  # This pool checks background behavior with paired MIRI MRS/Imaging exposures
