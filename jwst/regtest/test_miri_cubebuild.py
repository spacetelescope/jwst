...
@pytest.mark.bigdata
@pytest.mark.parametrize("output", ["jw01024-o001_t002_miri_ch1-short_s3d.fits", "jw01024-o001_t002_miri_ch2-short_s3d.fits"])
...
def test_cube_build_miri_ifualign(rtdata, fitsdiff_default_kwargs):
    ...
    args = ["jwst.cube_build.CubeBuildStep", input_file, "--coord_system=ifualign"]
    Step.from_cmdline(args)
