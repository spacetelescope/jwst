...
@pytest.mark.parametrize(
    "output",
    [
        "jw01024-o001_t002_miri_ch1-short_s3d.fits",
        "jw01024-o001_t002_miri_ch2-short_s3d.fits",
    ],
)
def test_cube_build_single_output(
    run_cube_build_single_output, output, fitsdiff_default_kwargs
):
...
def test_cube_build_miri_internal_cal(rtdata, fitsdiff_default_kwargs):
    ...
    args = ["jwst.cube_build.CubeBuildStep", input_file, "--coord_system=internal_cal"]
    Step.from_cmdline(args)
