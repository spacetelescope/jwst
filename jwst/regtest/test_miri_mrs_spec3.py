...
def run_spec3(jail, rtdata_module):
    ...
    rtdata.get_asn('miri/mrs/jw01024-c10000_04101_spec3_00001_asn.json')
...
def run_spec3_multi(jail, rtdata_module):
    """Run the Spec3Pipeline on multi channel data"""

    step_params = {
        'input_path': INPUT_PATH + '/' + 'jw01024-c10000_04101_spec3_00001_asn.json',
        'step': 'calwebb_spec3',
        'args': [
            '--steps.master_background.save_results=true',
            '--steps.outlier_detection.save_results=true',
