...
def test_cube_build_nirspec_medium_nonlinear(rtdata, fitsdiff_default_kwargs):
    ...
    output_name = "jw01536003001_06101_00001_nrs1_nonlinear"
    args = [
        "jwst.cube_build.CubeBuildStep",
        input_file,
        "--linear_wave=False",
    ...
    Step.from_cmdline(args)
    output = output_name + "_g235m-f170lp_s3d.fits"
...
@pytest.mark.bigdata
def test_cube_build_nirspec_high_nonlinear(rtdata, fitsdiff_default_kwargs):
    """Run cube_build on high resolution data and produce a non-linear wavelength"""
    input_file = "jw01251004001_03107_00001_nrs2_cal.fits"
    rtdata.get_data(f"nirspec/ifu/{input_file}")

    output_name = "jw01251004001_03107_00001_nrs2_nonlinear"
    args = [
        "jwst.cube_build.CubeBuildStep",
        input_file,
        "--linear_wave=False",
    ...
    Step.from_cmdline(args)
    output = output_name + "_g395h-f290lp_s3d.fits"
