...
def test_miri_mrs_nod_masterbg(run_pipeline, fitsdiff_default_kwargs, nod_seq):
    ...
    rtdata = run_pipeline
    rtdata.output = "miri_mrs_nod_" + nod_seq + "_short12_exp1_master_background.fits"

    # Get the truth file
    rtdata.get_truth(
        os.path.join("truth/test_miri_mrs_nod_masterbg", "miri_mrs_nod_" + nod_seq + "_short12_exp1_master_background.fits")
    )
