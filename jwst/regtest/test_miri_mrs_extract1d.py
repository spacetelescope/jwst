...
def test_miri_mrs_extract1d_nominal(rtdata, fitsdiff_default_kwargs):
    ...
    # Get the truth file
    rtdata.get_truth(
        "truth/test_miri_mrs_extract1d/miri_003_det_image_seq1_MIRIFUSHORT_12SHORTexp1_extract1dstep.fits"
    )
...
def test_miri_mrs_extract1d_center(rtdata, fitsdiff_default_kwargs):
    ...
    Step.from_cmdline(args)
    rtdata.output = (
        "miri_003_det_image_seq1_MIRIFUSHORT_12SHORTexp1_center_extract1dstep.fits"
    )
