...
def test_spec3_multi(run_spec3_multi, fitsdiff_default_kwargs, output):
    ...
    rt.is_like_truth(run_spec3_multi, fitsdiff_default_kwargs, output, truth_path=TRUTH_PATH, is_suffix=False)
...
def test_spec3_multi_pixel_replace(run_spec3_multi_pixel_replace, fitsdiff_default_kwargs, output):
    """Regression test matching output files"""
    rt.is_like_truth(
        run_spec3_multi_pixel_replace, fitsdiff_default_kwargs, output, truth_path=TRUTH_PATH_PIXEL_REPLACE, is_suffix=False
    )
