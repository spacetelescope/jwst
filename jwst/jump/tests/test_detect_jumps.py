...
def test_exec_time_0_crs(setup_inputs):
    ...
    added code.
    """
    model, rnoise, gain = setup_inputs(
        ngroups=10, nrows=1024, ncols=1032, nints=2, readnoise=6.5, gain=5.5, grouptime=2.775, deltatime=2.775
    )
...
def test_exec_time_many_crs(setup_inputs):
    ...
    model, rnoise, gain = setup_inputs(
        ngroups=10, nrows=nrows, ncols=ncols, nints=2, readnoise=6.5, gain=5.5, grouptime=2.775, deltatime=2.775
    )
...
def test_nocr_100_groups_nframes1(setup_inputs):
    ...
    ngroups = 100
    model, rnoise, gain = setup_inputs(
        ngroups=ngroups, gain=ingain, nframes=1, nrows=10, ncols=10, readnoise=inreadnoise, deltatime=grouptime
    )
...
def test_twoints_onecr_each_10_groups_neighbors_flagged(setup_inputs):
    ...
    ngroups = 10
    model, rnoise, gain = setup_inputs(
        ngroups=ngroups, nints=2, gain=ingain, nrows=20, ncols=20, readnoise=inreadnoise, deltatime=grouptime
    )
...
def test_multiple_neighbor_jumps_firstlastbad(setup_inputs):
    ...
    model, rnoise, gain = setup_inputs(
        ngroups=ngroups, nints=1, nrows=nrows, ncols=ncols, gain=ingain, readnoise=inreadnoise, deltatime=grouptime
    )
...
def test_flagging_of_CRs_across_slice_boundaries(setup_inputs):
    ...
    model, rnoise, gain = setup_inputs(ngroups=ngroups, nints=2, gain=ingain, readnoise=inreadnoise, deltatime=grouptime)
...
def test_twoints_onecr_10_groups_neighbors_flagged_multi(setup_inputs):
    ...
    ngroups = 10
    model, rnoise, gain = setup_inputs(
        ngroups=ngroups, nints=2, gain=ingain, nrows=40, ncols=10, readnoise=inreadnoise, deltatime=grouptime
    )
...
def test_every_pixel_CR_neighbors_flagged(setup_inputs):
    ...
    ngroups = 10
    model, rnoise, gain = setup_inputs(
        ngroups=ngroups, gain=ingain, nrows=100, ncols=100, readnoise=inreadnoise, deltatime=grouptime
    )
...
def test_single_CR_neighbor_flag(setup_inputs):
    ...
    model, rnoise, gain = setup_inputs(ngroups=ngroups, nrows=5, ncols=6, gain=ingain, readnoise=inreadnoise, deltatime=grouptime)
...
def test_proc(setup_inputs):
    ...
    model, rnoise, gain = setup_inputs(
        ngroups=ngroups, nrows=25, ncols=6, nints=2, gain=ingain, readnoise=inreadnoise, deltatime=grouptime
    )
...
def test_cr_neighbor_sat_flagging(setup_inputs):
    ...
    inreadnoise = 7.0
    ngroups = 8
    model, rnoise, gain = setup_inputs(ngroups=ngroups, gain=ingain, nrows=6, ncols=7, readnoise=inreadnoise, deltatime=grouptime)
...
def setup_inputs():
    def _setup(
        ngroups=10, readnoise=10, nints=1, nrows=102, ncols=103, nframes=1, grouptime=1.0, gain=1, deltatime=1, subarray=False
    ):
        if subarray:
