...
def run_detect_jumps(input_model, gain_model, readnoise_model,
    ...
    # place holder for future adding of optional output of the calculated std dev
#    fits.writeto(output_model.meta.observation.obs_id + "_stddev.fits", stddev, overwrite=True)
