...
def find_crs(data, group_dq, read_noise, rej_threshold, nframes):
    ...
    # Reset groups set to DO_NOT_USE  values in input data array to NaN, so they don't get
    # used in any of the subsequent calculations. For MIRI data the first and last frame
